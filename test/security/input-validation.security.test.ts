  ...
  describe('WhatsApp Webhook Input Validation', () => {
    ...
    it('should handle null or undefined fields properly', async () => {
      const testCases = [
        ...
        { MessageSid: 'SM123456789', From: 'whatsapp:+18765551234', Body: null, WaId: '18765551234' },
  ...
  describe('Denial of Service Prevention', () => {
    ...
    it('should handle malformed JSON payloads', async () => {
      ...
      const response = await request(app.getHttpServer())
        ...
        .send('{"MessageSid":"SM123456789", "From":"whatsapp:+18765551234", "Body": malformed JSON here');
