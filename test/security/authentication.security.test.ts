...
describe('Authentication & Session Security Tests', () => {
  ...
  describe('Session Security', () => {
    ...
    it('should enforce session security boundaries', async () => {
      ...
      const user1Session = await sessionService.createSession(user1WhatsappId, user1PhoneNumber, 'flash-user-1');
      const user2Session = await sessionService.createSession(user2WhatsappId, user2PhoneNumber, 'flash-user-2');
